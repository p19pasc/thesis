...
<body>
    ...
    <h3 id="main_title">Συνέδρια</h3>

    <!-- Responsive container for the display of the data from conference mysql table with table structure -->
        ...
        ?>
            ...
            <thead>
                ...
                <?php 
                    ...
                    $_SESSION["table_name"] = "conference";
                    $_SESSION["id_name"] = "conferenceID";
                    $_SESSION["description_name"] = "conferenceName";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new conference name</p>
