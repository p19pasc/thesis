...
<head>
    ...
    <title>Κατηγορίες Εγγράφων</title>
    <style>
        <?php 
...
<body>
    ...
    <h3 id="main_title">Κατηγορίες Εγγράφων</h3>

    <!-- Responsive container for the display of the data from documentCategory mysql table with table structure -->
    <div class="container col-9 col-sm-8 col-md-6 col-lg-5 col-xl-4 text-center">
        ...
        ?>
            ...
            <thead>
                ...
                <?php 
                    ...
                    $_SESSION["table_name"] = "documentcategory";
                    $_SESSION["id_name"] = "documentCategoryID";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new document category</p>
