...
<head>
    ...
    <title>Χώροι Αποθήκευσης Τεχνουργημάτων</title>
    <style>
        <?php 
...
<body>
    ...
    <h3 id="main_title">Χώροι Αποθήκευσης Τεχνουργημάτων</h3>

    <!-- Responsive container for the display of the data from storageplace mysql table with table structure -->
    <div class="container col-9 col-sm-8 col-md-7 col-lg-6 col-xl-5 text-center">
        ...
        ?>
            ...
            <thead>
                ...
                <?php 
                    ...
                    $_SESSION["table_name"] = "storageplace";
                    $_SESSION["id_name"] = "storagePlaceID";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new storage place</p>
