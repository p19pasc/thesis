...
<head>
    ...
    <title>Είδη Λογοτεχνικών Πηγών</title>
    <style>
        <?php 
...
<body>
    ...
    <!-- When user navigates from the page that has this session it should be unset -->
    <?php unset($_SESSION["greater_description_name"]); ?> 
  
    <h3 id="main_title">Είδη Λογοτεχνικών Πηγών</h3>

    <!-- Responsive container for the display of the data from literarysourcetype mysql table with table structure -->
    <div class="container col-9 col-sm-6 col-md-5 col-lg-4 col-xl-3 text-center">
        ...
        <table class="table table-striped">
            ...
            <?php 
                ...
                $_SESSION["table_name"] = "literarysourcetype";
                $_SESSION["id_name"] = "literarySourceTypeID";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new literary source type</p>
