...
<head>
    ...
    <title>Οικογενειακή Κατάσταση</title>
    <style>
        <?php 
...
<body>
    ...
    <h3 id="main_title">Οικογενειακή Κατάσταση</h3>

    <!-- Responsive container for the display of the data from maritalstatus mysql table with table structure -->
