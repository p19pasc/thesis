...
<body>
    ...
    <h3 id="main_title">Συγγραφείς</h3>

    <!-- Responsive container for the display of the data from author mysql table with table structure -->
    <div class="container col-9 col-sm-9 col-md-9 col-lg-9 col-xl-7 text-center table-responsive">
        ...
        <table class="table table-striped">
            ...
            <?php 
                ...
                $_SESSION["table_name"] = "author";
                $_SESSION["id_name"] = "authorID";
                $_SESSION["description_name"] = "authorFirstName";
                $_SESSION["greater_description_name"]="authorSurname";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new author</p>
        <div class="textarea_box">
        <input type="text" maxlength="255" name="description_box" placeholder="Όνομα">
        <input type="text" maxlength="255" name="greater_description_box" placeholder="Επίθετο">
        </div>
