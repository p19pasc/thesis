...
<head>
    ...
    <title>Κατηγορία Θέσης Αρχαιολογικών Καταλοίπων</title>
    <style>
        <?php 
    ...
    <script type="text/javascript" src="teleport_button.js"></script></head>
<body>
    ...
    <h3 id="main_title">Κατηγορία Θέσης Αρχαιολογικών Καταλοίπων</h3>

    <!-- Responsive container for the display of the data from sitekind mysql table with table structure -->
    <div class="container col-9 col-sm-6 col-md-5 col-lg-4 col-xl-3 text-center">
        ...
        <table class="table table-striped">
            ...
            <?php 
                ...
                $_SESSION["table_name"] = "sitekind";
                $_SESSION["id_name"] = "kindOfSiteID";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new kind of Site</p>
