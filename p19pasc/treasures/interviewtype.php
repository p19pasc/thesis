...
<body>
    ...
    <h3 id="main_title">Είδος Συνέντευξης</h3>

    <!-- Responsive container for the display of the data from interviewtype mysql table with table structure -->
    <div class="container col-9 col-sm-6 col-md-5 col-lg-4 col-xl-3 text-center">
        ...
        <table class="table table-striped">
            ...
            <?php 
                ...
                $_SESSION["table_name"] = "interviewtype";
                $_SESSION["id_name"] = "interviewTypeID";
    ...
    <form id="add_new_column" action="treasuresINSERT.php" method="POST">
        <p id="paragraph">Add new interview type</p>
